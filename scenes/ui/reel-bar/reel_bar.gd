...
func set_safe_zone(safe_zone_size: float, safe_zone_position: float) -> void:
	safe_zone.size.x = safe_zone_size * BAR_WIDTH
	safe_zone.position.x = safe_zone_position * BAR_WIDTH
